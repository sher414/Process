...
- Agente de productividad semanal
- Extracción de información con IA (Gemini)
- Monitor de Google Drive + bitácora con IA
- Generación de PDF vía HTTP + Google Apps Script
- Soporte y seguimiento de pedidos
- Workflows individuales (inscripción a eventos, alerta de saldo bancario)
- **[Tareas Post-Reunión con IA](./Automatizaciones/TareasPostReunionAI)** ← _nuevo_ — extracción automática de action items desde transcripciones de reuniones, con creación de tarjetas en Trello y Asana
...
- **IA / LLMs** — Gemini, modelos de lenguaje para procesamiento
- **Google Workspace** — Drive, Sheets, Forms, Apps Script
- **APIs y HTTP Requests** — integración con servicios externos
- **Webhooks** — disparadores en tiempo real
- **Trello / Asana** — gestores de proyectos integrados vía API
